...
L:RegisterTranslations("enUS", function() return {
  ...
  frenzy_active_bar = "Frenzy active",
  frenzy_bar = "Possible Frenzy",
  frenzy_first_bar = "Frenzy",
...
L:RegisterTranslations("deDE", function() return {
  ...
  frenzy_active_bar = "Magmadar ist wütend!",
  frenzy_bar = "Möglicher Wutanfall",
  frenzy_first_bar = "Wutanfall",
  frenzyfade_trigger = "Wutanfall schwindet von Magmadar.",

  frenzyann = "Raserei! Jetzt einlullen!!11einself",
...
function BigWigsMagmadar:BigWigs_RecvSync(sync, rest, nick)
  if not self.started and sync == "BossEngaged" and rest == self.bossSync then
    self:StartFight()
    self:ScheduleEvent("BigWigs_Message", 5, L["fearsoon"], "Attention")
    self:TriggerEvent("BigWigs_StartBar", self, L["fear_first_bar"], 10, "Interface\\Icons\\Spell_Shadow_DeathScream")
    self:TriggerEvent("BigWigs_StartBar", self, L["frenzy_first_bar"], 15, "Interface\\Icons\\Ability_Druid_ChallangingRoar")
  elseif sync == "MagmadarPanic" and self.db.profile.panic then
    self:TriggerEvent("BigWigs_StopBar", self, L["fear_first_bar"])
  ...
  elseif sync == "MagmadarFrenzyStop" and self.db.profile.frenzy then
    self:TriggerEvent("BigWigs_StopBar", self, L["frenzy_active_bar"])
